...
import (
	...
	"github.com/CSPF-Founder/iva/panel/views/pages"
...
func (c *updateController) index(w http.ResponseWriter, r *http.Request) {
	...
	updateResponse := pages.UpdateInfo{
		ColorStatus: "",
		Status:      "--",
		Updating:    false,
		LastUpdate:  "--",
	...
	templateData.Title = "Updater"
	if err := views.RenderTempl(pages.Updater(updateResponse), templateData, w, r); err != nil {
